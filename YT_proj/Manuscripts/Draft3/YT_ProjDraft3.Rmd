...
```{r EMTemps, fig.cap = 'Temperature projections of the different Bias tests. The medium projection follows the overall trend of historical data, and this was used as a baseline for the other OM temperature projections', echo = FALSE, warning = FALSE, message = FALSE}
