...
The Northeast Continental shelf is the fastest warming marine ecosystem in the United States, and thus accounting for this change is imperative to maintaining the sustainability and productivity of the region’s fisheries. Recently, climate-informed stock assessments have been developed in the U.S. northeast that include environmental covariates. Ocean models such as those developed under NOAA’s Climate Ecosystem Fisheries Initiative could help reduce management uncertainty if they can skillfully simulate and predict historical and future ocean conditions. Management Strategy Evaluations (MSEs) are a technique in fisheries management to simulate the effectiveness and trade-offs of different management options and thus assess climate-ready management plans. As a case study, the yellowtail flounder (Limanda ferruginea) is an important stock to the U.S. northeast groundfish fishery and its recruitment success is associated with ocean bottom temperatures. In this study we apply an MSE framework the Georges Bank stock of yellowtail flounder in the U.S. northeast to understand how different temperature projections perform in terms of model accuracy and providing useful management advice. THROW IN SENTENCE ABOUT FINDINGS ONCE YOU CHAT W GAVIN.
