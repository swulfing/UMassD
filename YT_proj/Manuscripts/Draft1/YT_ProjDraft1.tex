...
\begin{figure}
\includegraphics[width=29.17in]{Plots/Biases/EMtempPlot} \caption{Temperature projections of the different Bias tests. The medium projection follows the overall trend of historical data, and this was used as a baseline for the other bias projections}\label{fig:EMTemps}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{YT_ProjDraft1_files/figure-latex/biasProjOverTime-1.pdf}
\caption{\label{fig:biasProjOverTime}Calcualted environmnetal covariates from the EM updated at each assessment period. The ``True'' OM value is shown in the horizontal dashed line}
\end{figure}
...
\hline
AR(1) & -0.397 & -0.411 & 3.526 & 0.166\\
\hline
Bad Projection & -0.397 & -0.344 & -13.350 & 0.141\\
\hline
Good Projection & -0.397 & -0.260 & -34.509 & 0.137\\
\hline
Historical Average & -0.397 & -0.475 & 19.647 & 0.197\\
\hline
Recent Trend & -0.397 & -0.338 & -14.861 & 0.123\\
\hline
Recent Window & -0.397 & -0.380 & -4.282 & 0.149\\
\hline
Terminal Year & -0.397 & -0.302 & -23.929 & 0.141\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}
\centering
\includegraphics{YT_ProjDraft1_files/figure-latex/paramEstsproj-1.pdf}
\caption{\label{fig:paramEstsproj}Estimated ecological covariates in for the different biased temperature projections in the EM compared to the ``true'' value in the OM.}
\end{figure}

\begin{figure}
\centering
\includegraphics{YT_ProjDraft1_files/figure-latex/timeseriesparam-1.pdf}
\caption{\label{fig:timeseriesparam}Estimated ecological covariates in for the different temperature projection choices in the EM compared to the ``true'' value in the OM.}
\end{figure}
...
\includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-1.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-2.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-3.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-4.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-5.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-6.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-7.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-8.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-9.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/fixSSBIssue-10.pdf}
...
\caption{\label{fig:timeseriesrecruit}Percent difference of the calcualted recruitment per assessment year in each EM compared to the OM.}
\end{figure}

\begin{figure}
\centering
\includegraphics{YT_ProjDraft1_files/figure-latex/recruitmentDevs-1.pdf}
\caption{\label{fig:recruitmentDevs}Percent of recruitment deviation EXPLAINED BY THE ECOV IN EACH MODEL. MAKE SURE YOU CHANGE YOUR RESULTS PARAGRAPHS TO SAY THIS. ALSO FIX THIS BASED ON CHENG EMAIL}
\end{figure}

\includegraphics{YT_ProjDraft1_files/figure-latex/AutoCorrRecruitment-1.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/AutoCorrRecruitment-2.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/AutoCorrRecruitment-3.pdf} \includegraphics{YT_ProjDraft1_files/figure-latex/AutoCorrRecruitment-4.pdf}
...
{\centering \includegraphics[width=0.45\linewidth]{YT_ProjDraft1_files/figure-latex/ReferencePoints-1} \includegraphics[width=0.45\linewidth]{YT_ProjDraft1_files/figure-latex/ReferencePoints-2} 

}

\caption{Overfished (left) and overfishing (right) status over the projected time series for each EM. Overfished and overfishing thresholds are shown in the horizonal red line}\label{fig:ReferencePoints}
\end{figure}

\begin{figure}
\centering
\includegraphics{YT_ProjDraft1_files/figure-latex/BRPPerDiff-1.pdf}
\caption{\label{fig:BRPPerDiff}Percent difference of the calculated FXSPR reference point in each EM compared to the OM.}
\end{figure}
...
{\centering \includegraphics[width=0.3\linewidth]{Plots/Combo/RadarPlot_fix/Performance_Boxplot/Fbar_global_last_10_years} \includegraphics[width=0.3\linewidth]{Plots/Combo/RadarPlot_fix/Performance_Boxplot/Catch_last_10_years} \includegraphics[width=0.3\linewidth]{Plots/Combo/RadarPlot_fix/Performance_Boxplot/SSB_last_10_years} 
