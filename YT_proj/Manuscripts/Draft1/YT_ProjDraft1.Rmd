...
BRP_data <- readRDS('C:/Users/swulfing/Documents/MSE_results/Combo/BRP_data.rds')
```
...
```{r projterminal3, out.width="30%", fig.cap="Fbar, SSB, and catch of terminal 10 years of MSE in projections test", fig.show='hold', fig.align='center', echo = FALSE, warning = FALSE, message = FALSE}
