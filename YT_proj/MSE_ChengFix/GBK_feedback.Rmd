...
fitted_om <- readRDS("fitted_om.RDS") # all the parameter estimates should be saved in fitted_om$rep but it might be hard for you to understand/extract the information
...
q = c(2.134e-4,2.2267e-4,2.727e-4) # honestly I don't know q for each index, but you can check in the most recent stock assessment model
