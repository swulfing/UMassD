...
input_WITHEcov <- prepare_wham_input(basic_info = basic_info, 
                                   selectivity = sel2, 
                                   M = M, 
                                   NAA_re = NAA_re,
                                   ecov = ecov_me,
...
# input_WITHEcov[["data"]][["index_Neff"]] # Should I be making these NAs or 0?
# Answer: safer to just set 0 in input$data$use_indices: let model don't use the data for those NA years

# input_WITHEcov[["data"]][["Ecov_obs"]]

## Change Catch and Index Info

input <- prepare_wham_input(gb_dat) # this is the input from asap file

input_WITHEcov$data$agg_index_sigma
input_WITHEcov$data$use_indices
input_WITHEcov$data$use_index_paa

input_WITHEcov$data$agg_index_sigma[1:50,] = input$data$agg_index_sigma

input_WITHEcov$data$use_indices[1:50,] = input$data$use_indices

input_WITHEcov$data$use_index_paa[1:50,] = input$data$use_index_paa
...
input_WITHEcov <- update_input_index_info(input_WITHEcov, 
                                        agg_index_sigma = input_WITHEcov$data$agg_index_sigma, 
                                        index_Neff = input_WITHEcov$data$index_Neff,
