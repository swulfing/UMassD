# Load libraries
# library(wham, lib.loc = "C:\\Users\\chengxue.li\\AppData\\Local\\R\\win-library\\4.5\\multi_wham")
library(wham)
...
om2_test <- update_om_fn(om2, seed = 123, random = random)
om2_test$rep$Ecov_x
om2_test$parList$Ecov_re
