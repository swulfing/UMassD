...
input_NOEcov <- update_waa(input_Ecov, waa_info = waa_info)
...
input_NOEcov <- update_input_index_info(
  input_NOEcov,
...
om_NOecov <- fit_wham(input_NOEcov, do.fit = TRUE, do.brps = TRUE, MakeADFun.silent = FALSE)
check_convergence(om_NOecov)
plot_wham_output(om_NOecov, out.type = "html", dir.main = "C:/Users/swulfing/Documents/GitHub/UMassD/YT_proj/Results/om_noecov")
...
saveRDS(om_NOecov, "om_NOecov.rds")
